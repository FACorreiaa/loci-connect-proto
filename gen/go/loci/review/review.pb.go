...
func (ReviewStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_loci_review_review_proto_enumTypes[0].Descriptor()
}

func (ReviewStatus) Type() protoreflect.EnumType {
	return &file_loci_review_review_proto_enumTypes[0]
}
...
func (ReviewStatus) EnumDescriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{0}
}
...
func (SortDirection) Descriptor() protoreflect.EnumDescriptor {
	return file_loci_review_review_proto_enumTypes[1].Descriptor()
}

func (SortDirection) Type() protoreflect.EnumType {
	return &file_loci_review_review_proto_enumTypes[1]
}
...
func (SortDirection) EnumDescriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{1}
}
...
func (ReviewSortBy) Descriptor() protoreflect.EnumDescriptor {
	return file_loci_review_review_proto_enumTypes[2].Descriptor()
}

func (ReviewSortBy) Type() protoreflect.EnumType {
	return &file_loci_review_review_proto_enumTypes[2]
}
...
func (ReviewSortBy) EnumDescriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{2}
}
...
type Review struct {
	...
	Status    ReviewStatus           `protobuf:"varint,8,opt,name=status,proto3,enum=loci.review.ReviewStatus" json:"status,omitempty"`
...
func (x *Review) Reset() {
	*x = Review{}
	mi := &file_loci_review_review_proto_msgTypes[0]
...
func (x *ReviewAspects) Reset() {
	*x = ReviewAspects{}
	mi := &file_loci_review_review_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ReviewerInfo) Reset() {
	*x = ReviewerInfo{}
	mi := &file_loci_review_review_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *BusinessResponse) Reset() {
	*x = BusinessResponse{}
	mi := &file_loci_review_review_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ReviewStatistics struct {
	...
	RatingBreakdown      *RatingBreakdown       `protobuf:"bytes,4,opt,name=rating_breakdown,json=ratingBreakdown,proto3" json:"rating_breakdown,omitempty"`
...
func (x *ReviewStatistics) Reset() {
	*x = ReviewStatistics{}
	mi := &file_loci_review_review_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ReviewStatistics) GetRatingBreakdown() *RatingBreakdown {
	if x != nil {
...
type RatingBreakdown struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OneStar       int32                  `protobuf:"varint,1,opt,name=one_star,json=oneStar,proto3" json:"one_star,omitempty"`
	TwoStar       int32                  `protobuf:"varint,2,opt,name=two_star,json=twoStar,proto3" json:"two_star,omitempty"`
	ThreeStar     int32                  `protobuf:"varint,3,opt,name=three_star,json=threeStar,proto3" json:"three_star,omitempty"`
	FourStar      int32                  `protobuf:"varint,4,opt,name=four_star,json=fourStar,proto3" json:"four_star,omitempty"`
	FiveStar      int32                  `protobuf:"varint,5,opt,name=five_star,json=fiveStar,proto3" json:"five_star,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RatingBreakdown) Reset() {
	*x = RatingBreakdown{}
	mi := &file_loci_review_review_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RatingBreakdown) Descriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{5}
}
...
func (x *ReviewAspectAverages) Reset() {
	*x = ReviewAspectAverages{}
	mi := &file_loci_review_review_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReviewAspectAverages) Descriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{6}
}
...
func (x *RecentReviewTrends) Reset() {
	*x = RecentReviewTrends{}
	mi := &file_loci_review_review_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RecentReviewTrends) Descriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{7}
}
...
func (x *MonthlyReviewData) Reset() {
	*x = MonthlyReviewData{}
	mi := &file_loci_review_review_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MonthlyReviewData) Descriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{8}
}
...
func (x *ReviewTag) Reset() {
	*x = ReviewTag{}
	mi := &file_loci_review_review_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReviewTag) Descriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{9}
}
...
func (x *LanguageDistribution) Reset() {
	*x = LanguageDistribution{}
	mi := &file_loci_review_review_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LanguageDistribution) Descriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{10}
}
...
func (x *LanguageCount) Reset() {
	*x = LanguageCount{}
	mi := &file_loci_review_review_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LanguageCount) Descriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{11}
}
...
type ReviewFilter struct {
	...
	SortBy         ReviewSortBy           `protobuf:"varint,8,opt,name=sort_by,json=sortBy,proto3,enum=loci.review.ReviewSortBy" json:"sort_by,omitempty"`
	SortDirection  SortDirection          `protobuf:"varint,9,opt,name=sort_direction,json=sortDirection,proto3,enum=loci.review.SortDirection" json:"sort_direction,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ReviewFilter) Reset() {
	*x = ReviewFilter{}
	mi := &file_loci_review_review_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReviewFilter) Descriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{12}
}
...
func (x *ReviewFilter) GetSortDirection() SortDirection {
	if x != nil {
...
func (x *CreateReviewRequest) Reset() {
	*x = CreateReviewRequest{}
	mi := &file_loci_review_review_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateReviewRequest) Descriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{13}
}
...
func (x *CreateReviewResponse) Reset() {
	*x = CreateReviewResponse{}
	mi := &file_loci_review_review_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateReviewResponse) Descriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{14}
}
...
func (x *GetPOIReviewsRequest) Reset() {
	*x = GetPOIReviewsRequest{}
	mi := &file_loci_review_review_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetPOIReviewsRequest) Descriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{15}
}
...
func (x *GetPOIReviewsRequest) GetPagination() *common.PaginationRequest {
	if x != nil {
		return x.Pagination
	}
	return nil
...
func (x *GetPOIReviewsResponse) Reset() {
	*x = GetPOIReviewsResponse{}
	mi := &file_loci_review_review_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetPOIReviewsResponse) Descriptor() ([]byte, []int) {
	return file_loci_review_review_proto_rawDescGZIP(), []int{16}
}
...
func (x *GetPOIReviewsResponse) GetPagination() *common.PaginationMetadata {
	if x != nil {
		return x.Pagination
	}
	return nil
...
func (x *GetUserReviewsRequest) GetPagination() *common.PaginationRequest {
	if x != nil {
		return x.Pagination
	}
	return nil
...
func (x *GetUserReviewsResponse) GetPagination() *common.PaginationMetadata {
	if x != nil {
		return x.Pagination
	}
	return nil
...
const file_loci_review_review_proto_rawDesc = "" +
	"\n" +
	"\x18loci/review/review.proto\x12\vloci.review\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x18loci/common/common.proto\"\x81\a\n" +
	"\x06Review\x12\x19\n" +
	...
	"\x06status\x18\b \x01(\x0e2\x19.loci.review.ReviewStatusB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06status\x129\n" +
	"\n" +
	...
	"\n" +
	"updated_at\x18\v \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tupdatedAt\x12,\n" +
	...
	"\x11business_response\x18\x12 \x01(\v2\x1d.loci.review.BusinessResponseR\x10businessResponse\"\x8f\x05\n" +
	"\rReviewAspects\x12>\n" +
	...
	"\fvalue_rating\x18\x03 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\xf0?R\vvalueRating\x12D\n" +
	"\x11atmosphere_rating\x18\x04 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\xf0?R\x10atmosphereRating\x12F\n" +
	"\x12cleanliness_rating\x18\x05 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\xf0?R\x11cleanlinessRating\x12@\n" +
	"\x0flocation_rating\x18\x06 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\xf0?R\x0elocationRating\x128\n" +
	"\vfood_rating\x18\a \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\xf0?R\n" +
	"foodRating\x128\n" +
	"\vroom_rating\x18\b \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\xf0?R\n" +
	"roomRating\x12B\n" +
	...
	"\x10business_user_id\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x0ebusinessUserId\x12$\n" +
	"\acontent\x18\x03 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xd0\x0fR\acontent\x12A\n" +
	"\n" +
	"created_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tcreatedAt\x121\n" +
	"\x0eresponder_name\x18\x05 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xc8\x01R\rresponderName\x123\n" +
	"\x0fresponder_title\x18\x06 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xc8\x01R\x0eresponderTitle\"\xb3\x04\n" +
	...
	"\rtotal_reviews\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\ftotalReviews\x12G\n" +
	"\x10rating_breakdown\x18\x04 \x01(\v2\x1c.loci.review.RatingBreakdownR\x0fratingBreakdown\x12J\n" +
	"\x0faspect_averages\x18\x05 \x01(\v2!.loci.review.ReviewAspectAveragesR\x0easpectAverages\x127\n" +
	"\x06trends\x18\x06 \x01(\v2\x1f.loci.review.RecentReviewTrendsR\x06trends\x12*\n" +
	"\x04tags\x18\a \x03(\v2\x16.loci.review.ReviewTagR\x04tags\x12V\n" +
	"\x15language_distribution\x18\b \x01(\v2!.loci.review.LanguageDistributionR\x14languageDistribution\x12=\n" +
	...
	"\btwo_star\x18\x02 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\atwoStar\x12&\n" +
	"\n" +
	"three_star\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\tthreeStar\x12$\n" +
	"\tfour_star\x18\x04 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\bfourStar\x12$\n" +
	"\tfive_star\x18\x05 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\bfiveStar\"\xaa\x05\n" +
	"\x14ReviewAspectAverages\x12@\n" +
	"\x0fservice_average\x18\x01 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\x0eserviceAverage\x12@\n" +
	"\x0fquality_average\x18\x02 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\x0equalityAverage\x12<\n" +
	"\rvalue_average\x18\x03 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\fvalueAverage\x12F\n" +
	"\x12atmosphere_average\x18\x04 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\x11atmosphereAverage\x12H\n" +
	"\x13cleanliness_average\x18\x05 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\x12cleanlinessAverage\x12B\n" +
	"\x10location_average\x18\x06 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\x0flocationAverage\x12:\n" +
	"\ffood_average\x18\a \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\vfoodAverage\x12:\n" +
	...
	"\rstaff_average\x18\n" +
	" \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\fstaffAverage\"\xc5\x02\n" +
	...
	"\x18rating_change_percentage\x18\x04 \x01(\x01R\x16ratingChangePercentage\x12A\n" +
	"\fmonthly_data\x18\x05 \x03(\v2\x1e.loci.review.MonthlyReviewDataR\vmonthlyData\"\xbd\x01\n" +
	...
	"\freview_count\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\vreviewCount\x12>\n" +
	"\x0eaverage_rating\x18\x04 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\raverageRating\"\xb0\x01\n" +
	"\tReviewTag\x12\x1b\n" +
	...
	"\bcategory\x18\x04 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x182R\bcategory\"P\n" +
	"\x14LanguageDistribution\x128\n" +
	"\tlanguages\x18\x01 \x03(\v2\x1a.loci.review.LanguageCountR\tlanguages\"\xc7\x01\n" +
	"\rLanguageCount\x12.\n" +
	"\rlanguage_code\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x02\x18\n" +
	"R\flanguageCode\x12.\n" +
	"\rlanguage_name\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\flanguageName\x12\x1d\n" +
	...
	"\bend_date\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\aendDate\x12F\n" +
	"\tlanguages\x18\x04 \x03(\tB(\xbaH%\x92\x01\"\x10\n" +
	"\"\x1er\x1c\x10\x02\x18\n" +
	"2\x16^[a-z]{2}(-[A-Z]{2})?$R\tlanguages\x12#\n" +
	...
	"\x0esort_direction\x18\t \x01(\x0e2\x1a.loci.review.SortDirectionR\rsortDirection\"\xb9\x03\n" +
	...
	"\n" +
	"photo_urls\x18\x06 \x03(\tB\x14\xbaH\x11\x92\x01\x0e\x10\n" +
	"\"\n" +
	...
	"2\x16^[a-z]{2}(-[A-Z]{2})?$R\blanguage\"v\n" +
	"\x14CreateReviewResponse\x121\n" +
	"\bresponse\x18\x01 \x01(\v2\x15.loci.common.ResponseR\bresponse\x12+\n" +
	"\x06review\x18\x02 \x01(\v2\x13.loci.review.ReviewR\x06review\"\xab\x01\n" +
	"\x14GetPOIReviewsRequest\x12 \n" +
	"\x06poi_id\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x05poiId\x12>\n" +
	"\n" +
	"pagination\x18\x02 \x01(\v2\x1e.loci.common.PaginationRequestR\n" +
	"pagination\x121\n" +
	"\x06filter\x18\x03 \x01(\v2\x19.loci.review.ReviewFilterR\x06filter\"\xc6\x01\n" +
	"\x15GetPOIReviewsResponse\x12-\n" +
	...
	"\xbaH\a\xd8\x01\x01r\x02\x18dR\x06userId\"z\n" +
	...
	"pagination\x18\x02 \x01(\v2\x1e.loci.common.PaginationRequestR\n" +
	"pagination\x121\n" +
	"\x06filter\x18\x03 \x01(\v2\x19.loci.review.ReviewFilterR\x06filter\"\xcb\x01\n" +
	...
	"pagination\x12A\n" +
	"\n" +
	"statistics\x18\x03 \x01(\v2!.loci.review.UserReviewStatisticsR\n" +
	"statistics\"\xb8\x02\n" +
	...
	"\bresponse\x18\x01 \x01(\v2\x15.loci.common.ResponseR\bresponse\x12*\n" +
	"\x11new_helpful_count\x18\x02 \x01(\x05R\x0fnewHelpfulCount\"\xac\x01\n" +
	"\x13ReportReviewRequest\x12\"\n" +
	"\auser_id\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x06userId\x12&\n" +
	"\treview_id\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\breviewId\x12\"\n" +
	"\x06reason\x18\x03 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xc8\x01R\x06reason\x12%\n" +
	"\adetails\x18\x04 \x01(\tB\v\xbaH\b\xd8\x01\x01r\x03\x18\xe8\aR\adetails\"I\n" +
	"\x14ReportReviewResponse\x121\n" +
	"\bresponse\x18\x01 \x01(\v2\x15.loci.common.ResponseR\bresponse\"\x88\x01\n" +
	"\x1aGetReviewStatisticsRequest\x12 \n" +
	"\x06poi_id\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x05poiId\x12%\n" +
	"\x0einclude_trends\x18\x02 \x01(\bR\rincludeTrends\x12!\n" +
	"\finclude_tags\x18\x03 \x01(\bR\vincludeTags\"\\\n" +
	...
	"\x18REVIEW_SORT_BY_RELEVANCE\x10\x042\x9b\x06\n" +
	"\rReviewService\x12S\n" +
	"\fCreateReview\x12 .loci.review.CreateReviewRequest\x1a!.loci.review.CreateReviewResponse\x12V\n" +
	"\rGetPOIReviews\x12!.loci.review.GetPOIReviewsRequest\x1a\".loci.review.GetPOIReviewsResponse\x12J\n" +
	"\tGetReview\x12\x1d.loci.review.GetReviewRequest\x1a\x1e.loci.review.GetReviewResponse\x12S\n" +
	"\fUpdateReview\x12 .loci.review.UpdateReviewRequest\x1a!.loci.review.UpdateReviewResponse\x12S\n" +
	"\fDeleteReview\x12 .loci.review.DeleteReviewRequest\x1a!.loci.review.DeleteReviewResponse\x12Y\n" +
	"\x0eGetUserReviews\x12\".loci.review.GetUserReviewsRequest\x1a#.loci.review.GetUserReviewsResponse\x12M\n" +
	"\n" +
...
var (
	...
	file_loci_review_review_proto_rawDescData []byte
)

func file_loci_review_review_proto_rawDescGZIP() []byte {
	file_loci_review_review_proto_rawDescOnce.Do(func() {
		file_loci_review_review_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_loci_review_review_proto_rawDesc), len(file_loci_review_review_proto_rawDesc)))
	})
...
var file_loci_review_review_proto_goTypes = []any{
	(ReviewStatus)(0),                   // 0: loci.review.ReviewStatus
	(SortDirection)(0),                  // 1: loci.review.SortDirection
	(ReviewSortBy)(0),                   // 2: loci.review.ReviewSortBy
	(*Review)(nil),                      // 3: loci.review.Review
	(*ReviewAspects)(nil),               // 4: loci.review.ReviewAspects
	(*ReviewerInfo)(nil),                // 5: loci.review.ReviewerInfo
	(*BusinessResponse)(nil),            // 6: loci.review.BusinessResponse
	(*ReviewStatistics)(nil),            // 7: loci.review.ReviewStatistics
	(*RatingBreakdown)(nil),             // 8: loci.review.RatingBreakdown
	(*ReviewAspectAverages)(nil),        // 9: loci.review.ReviewAspectAverages
	(*RecentReviewTrends)(nil),          // 10: loci.review.RecentReviewTrends
	(*MonthlyReviewData)(nil),           // 11: loci.review.MonthlyReviewData
	(*ReviewTag)(nil),                   // 12: loci.review.ReviewTag
	(*LanguageDistribution)(nil),        // 13: loci.review.LanguageDistribution
	(*LanguageCount)(nil),               // 14: loci.review.LanguageCount
	(*ReviewFilter)(nil),                // 15: loci.review.ReviewFilter
	(*CreateReviewRequest)(nil),         // 16: loci.review.CreateReviewRequest
	(*CreateReviewResponse)(nil),        // 17: loci.review.CreateReviewResponse
	(*GetPOIReviewsRequest)(nil),        // 18: loci.review.GetPOIReviewsRequest
	(*GetPOIReviewsResponse)(nil),       // 19: loci.review.GetPOIReviewsResponse
	(*GetReviewRequest)(nil),            // 20: loci.review.GetReviewRequest
	(*GetReviewResponse)(nil),           // 21: loci.review.GetReviewResponse
	(*UpdateReviewRequest)(nil),         // 22: loci.review.UpdateReviewRequest
	(*UpdateReviewResponse)(nil),        // 23: loci.review.UpdateReviewResponse
	(*DeleteReviewRequest)(nil),         // 24: loci.review.DeleteReviewRequest
	(*DeleteReviewResponse)(nil),        // 25: loci.review.DeleteReviewResponse
	(*GetUserReviewsRequest)(nil),       // 26: loci.review.GetUserReviewsRequest
	(*GetUserReviewsResponse)(nil),      // 27: loci.review.GetUserReviewsResponse
	(*UserReviewStatistics)(nil),        // 28: loci.review.UserReviewStatistics
	(*LikeReviewRequest)(nil),           // 29: loci.review.LikeReviewRequest
	(*LikeReviewResponse)(nil),          // 30: loci.review.LikeReviewResponse
	(*ReportReviewRequest)(nil),         // 31: loci.review.ReportReviewRequest
	(*ReportReviewResponse)(nil),        // 32: loci.review.ReportReviewResponse
	(*GetReviewStatisticsRequest)(nil),  // 33: loci.review.GetReviewStatisticsRequest
	(*GetReviewStatisticsResponse)(nil), // 34: loci.review.GetReviewStatisticsResponse
...
var file_loci_review_review_proto_depIdxs = []int32{
	0,  // 0: loci.review.Review.status:type_name -> loci.review.ReviewStatus
	35, // 1: loci.review.Review.visit_date:type_name -> google.protobuf.Timestamp
	35, // 2: loci.review.Review.created_at:type_name -> google.protobuf.Timestamp
	35, // 3: loci.review.Review.updated_at:type_name -> google.protobuf.Timestamp
	4,  // 4: loci.review.Review.aspects:type_name -> loci.review.ReviewAspects
	5,  // 5: loci.review.Review.reviewer:type_name -> loci.review.ReviewerInfo
	6,  // 6: loci.review.Review.business_response:type_name -> loci.review.BusinessResponse
	35, // 7: loci.review.ReviewerInfo.member_since:type_name -> google.protobuf.Timestamp
	35, // 8: loci.review.BusinessResponse.created_at:type_name -> google.protobuf.Timestamp
	8,  // 9: loci.review.ReviewStatistics.rating_breakdown:type_name -> loci.review.RatingBreakdown
	9,  // 10: loci.review.ReviewStatistics.aspect_averages:type_name -> loci.review.ReviewAspectAverages
	10, // 11: loci.review.ReviewStatistics.trends:type_name -> loci.review.RecentReviewTrends
	12, // 12: loci.review.ReviewStatistics.tags:type_name -> loci.review.ReviewTag
	13, // 13: loci.review.ReviewStatistics.language_distribution:type_name -> loci.review.LanguageDistribution
	35, // 14: loci.review.ReviewStatistics.last_updated:type_name -> google.protobuf.Timestamp
	11, // 15: loci.review.RecentReviewTrends.monthly_data:type_name -> loci.review.MonthlyReviewData
	14, // 16: loci.review.LanguageDistribution.languages:type_name -> loci.review.LanguageCount
	35, // 17: loci.review.ReviewFilter.start_date:type_name -> google.protobuf.Timestamp
	35, // 18: loci.review.ReviewFilter.end_date:type_name -> google.protobuf.Timestamp
	2,  // 19: loci.review.ReviewFilter.sort_by:type_name -> loci.review.ReviewSortBy
	1,  // 20: loci.review.ReviewFilter.sort_direction:type_name -> loci.review.SortDirection
	35, // 21: loci.review.CreateReviewRequest.visit_date:type_name -> google.protobuf.Timestamp
	4,  // 22: loci.review.CreateReviewRequest.aspects:type_name -> loci.review.ReviewAspects
	36, // 23: loci.review.CreateReviewResponse.response:type_name -> loci.common.Response
	3,  // 24: loci.review.CreateReviewResponse.review:type_name -> loci.review.Review
	37, // 25: loci.review.GetPOIReviewsRequest.pagination:type_name -> loci.common.PaginationRequest
	15, // 26: loci.review.GetPOIReviewsRequest.filter:type_name -> loci.review.ReviewFilter
	3,  // 27: loci.review.GetPOIReviewsResponse.reviews:type_name -> loci.review.Review
	38, // 28: loci.review.GetPOIReviewsResponse.pagination:type_name -> loci.common.PaginationMetadata
	7,  // 29: loci.review.GetPOIReviewsResponse.statistics:type_name -> loci.review.ReviewStatistics
	3,  // 30: loci.review.GetReviewResponse.review:type_name -> loci.review.Review
	35, // 31: loci.review.UpdateReviewRequest.visit_date:type_name -> google.protobuf.Timestamp
	4,  // 32: loci.review.UpdateReviewRequest.aspects:type_name -> loci.review.ReviewAspects
	36, // 33: loci.review.UpdateReviewResponse.response:type_name -> loci.common.Response
	3,  // 34: loci.review.UpdateReviewResponse.review:type_name -> loci.review.Review
	36, // 35: loci.review.DeleteReviewResponse.response:type_name -> loci.common.Response
	37, // 36: loci.review.GetUserReviewsRequest.pagination:type_name -> loci.common.PaginationRequest
	15, // 37: loci.review.GetUserReviewsRequest.filter:type_name -> loci.review.ReviewFilter
	3,  // 38: loci.review.GetUserReviewsResponse.reviews:type_name -> loci.review.Review
	38, // 39: loci.review.GetUserReviewsResponse.pagination:type_name -> loci.common.PaginationMetadata
	28, // 40: loci.review.GetUserReviewsResponse.statistics:type_name -> loci.review.UserReviewStatistics
	36, // 41: loci.review.LikeReviewResponse.response:type_name -> loci.common.Response
	36, // 42: loci.review.ReportReviewResponse.response:type_name -> loci.common.Response
	7,  // 43: loci.review.GetReviewStatisticsResponse.statistics:type_name -> loci.review.ReviewStatistics
	16, // 44: loci.review.ReviewService.CreateReview:input_type -> loci.review.CreateReviewRequest
	18, // 45: loci.review.ReviewService.GetPOIReviews:input_type -> loci.review.GetPOIReviewsRequest
	20, // 46: loci.review.ReviewService.GetReview:input_type -> loci.review.GetReviewRequest
	22, // 47: loci.review.ReviewService.UpdateReview:input_type -> loci.review.UpdateReviewRequest
	24, // 48: loci.review.ReviewService.DeleteReview:input_type -> loci.review.DeleteReviewRequest
	26, // 49: loci.review.ReviewService.GetUserReviews:input_type -> loci.review.GetUserReviewsRequest
	29, // 50: loci.review.ReviewService.LikeReview:input_type -> loci.review.LikeReviewRequest
	31, // 51: loci.review.ReviewService.ReportReview:input_type -> loci.review.ReportReviewRequest
	33, // 52: loci.review.ReviewService.GetReviewStatistics:input_type -> loci.review.GetReviewStatisticsRequest
	17, // 53: loci.review.ReviewService.CreateReview:output_type -> loci.review.CreateReviewResponse
	19, // 54: loci.review.ReviewService.GetPOIReviews:output_type -> loci.review.GetPOIReviewsResponse
	21, // 55: loci.review.ReviewService.GetReview:output_type -> loci.review.GetReviewResponse
	23, // 56: loci.review.ReviewService.UpdateReview:output_type -> loci.review.UpdateReviewResponse
	25, // 57: loci.review.ReviewService.DeleteReview:output_type -> loci.review.DeleteReviewResponse
	27, // 58: loci.review.ReviewService.GetUserReviews:output_type -> loci.review.GetUserReviewsResponse
	30, // 59: loci.review.ReviewService.LikeReview:output_type -> loci.review.LikeReviewResponse
	32, // 60: loci.review.ReviewService.ReportReview:output_type -> loci.review.ReportReviewResponse
	34, // 61: loci.review.ReviewService.GetReviewStatistics:output_type -> loci.review.GetReviewStatisticsResponse
...
func file_loci_review_review_proto_init() {
	if File_loci_review_review_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_loci_review_review_proto_goTypes,
		DependencyIndexes: file_loci_review_review_proto_depIdxs,
		EnumInfos:         file_loci_review_review_proto_enumTypes,
		MessageInfos:      file_loci_review_review_proto_msgTypes,
	}.Build()
	File_loci_review_review_proto = out.File
	file_loci_review_review_proto_goTypes = nil
	file_loci_review_review_proto_depIdxs = nil
}
