...
const (
	PackingCategory_PACKING_CATEGORY_UNSPECIFIED PackingCategory = 0
	PackingCategory_PACKING_CATEGORY_ESSENTIALS  PackingCategory = 1
	PackingCategory_PACKING_CATEGORY_CLOTHING    PackingCategory = 2
	PackingCategory_PACKING_CATEGORY_WEATHER     PackingCategory = 3
	PackingCategory_PACKING_CATEGORY_TECH        PackingCategory = 4
	PackingCategory_PACKING_CATEGORY_HEALTH      PackingCategory = 5
	PackingCategory_PACKING_CATEGORY_TRAVEL      PackingCategory = 6
	PackingCategory_PACKING_CATEGORY_ACTIVITY    PackingCategory = 7
)

// Enum value maps for PackingCategory.
var (
	PackingCategory_name = map[int32]string{
		0: "PACKING_CATEGORY_UNSPECIFIED",
		1: "PACKING_CATEGORY_ESSENTIALS",
		2: "PACKING_CATEGORY_CLOTHING",
		3: "PACKING_CATEGORY_WEATHER",
		4: "PACKING_CATEGORY_TECH",
		5: "PACKING_CATEGORY_HEALTH",
		6: "PACKING_CATEGORY_TRAVEL",
		7: "PACKING_CATEGORY_ACTIVITY",
	}
	PackingCategory_value = map[string]int32{
...
func (x PackingCategory) Enum() *PackingCategory {
	p := new(PackingCategory)
	*p = x
	return p
}

func (x PackingCategory) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
type ChecklistItemKind int32

const (
	ChecklistItemKind_CHECKLIST_ITEM_KIND_UNSPECIFIED ChecklistItemKind = 0
	ChecklistItemKind_CHECKLIST_ITEM_KIND_PACKING     ChecklistItemKind = 1
	ChecklistItemKind_CHECKLIST_ITEM_KIND_EXPENSE     ChecklistItemKind = 2
)

// Enum value maps for ChecklistItemKind.
var (
	ChecklistItemKind_name = map[int32]string{
		0: "CHECKLIST_ITEM_KIND_UNSPECIFIED",
		1: "CHECKLIST_ITEM_KIND_PACKING",
		2: "CHECKLIST_ITEM_KIND_EXPENSE",
	}
	ChecklistItemKind_value = map[string]int32{
		"CHECKLIST_ITEM_KIND_UNSPECIFIED": 0,
		"CHECKLIST_ITEM_KIND_PACKING":     1,
		"CHECKLIST_ITEM_KIND_EXPENSE":     2,
	}
)

func (x ChecklistItemKind) Enum() *ChecklistItemKind {
	p := new(ChecklistItemKind)
	*p = x
	return p
}

func (x ChecklistItemKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
type TripDay struct {
	...
	CityLat  *float64 `protobuf:"fixed64,7,opt,name=city_lat,json=cityLat,proto3,oneof" json:"city_lat,omitempty"`
...
func (x *TripDay) GetCityName() string {
	if x != nil {
		return x.CityName
	}
	return ""
...
func (x *TripDay) GetCityId() string {
...
func (x *TripDay) GetCityLat() float64 {
...
func (x *TripDay) GetCityLon() float64 {
	if x != nil && x.CityLon != nil {
		return *x.CityLon
	}
	return 0
}

func (x *TripDay) GetTravelDay() bool {
	if x != nil {
		return x.TravelDay
	}
	return false
...
type TripLeg struct {
	...
	FromLat      float64                `protobuf:"fixed64,4,opt,name=from_lat,json=fromLat,proto3" json:"from_lat,omitempty"`
	FromLon      float64                `protobuf:"fixed64,5,opt,name=from_lon,json=fromLon,proto3" json:"from_lon,omitempty"`
	ToLat        float64                `protobuf:"fixed64,6,opt,name=to_lat,json=toLat,proto3" json:"to_lat,omitempty"`
	ToLon        float64                `protobuf:"fixed64,7,opt,name=to_lon,json=toLon,proto3" json:"to_lon,omitempty"`
...
func (x *TripLeg) GetFromName() string {
	if x != nil {
		return x.FromName
	}
	return ""
...
func (x *TripLeg) GetToName() string {
	if x != nil {
		return x.ToName
	}
	return ""
...
func (x *TripLeg) GetFromLat() float64 {
	if x != nil {
		return x.FromLat
	}
	return 0
...
func (x *TripLeg) GetFromLon() float64 {
	if x != nil {
		return x.FromLon
	}
	return 0
...
func (x *TripLeg) GetToLat() float64 {
	if x != nil {
		return x.ToLat
	}
	return 0
...
func (x *TripLeg) GetToLon() float64 {
	if x != nil {
		return x.ToLon
	}
	return 0
...
func (x *TripLeg) GetDistanceKm() float64 {
	if x != nil {
		return x.DistanceKm
	}
	return 0
...
func (x *TripLeg) GetDurationMins() int32 {
	if x != nil {
...
func (x *TripLeg) GetAfterDay() int32 {
	if x != nil {
		return x.AfterDay
	}
	return 0
...
func (x *TripLeg) GetBookingUrl() string {
	if x != nil && x.BookingUrl != nil {
		return *x.BookingUrl
	}
	return ""
...
func (x *TripDraft) GetLegs() []*TripLeg {
	if x != nil {
		return x.Legs
	}
	return nil
...
type PackingSuggestion struct {
	...
	Category PackingCategory        `protobuf:"varint,2,opt,name=category,proto3,enum=loci.trip.PackingCategory" json:"category,omitempty"`
...
func (x *PackingSuggestion) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PackingSuggestion) GetCategory() PackingCategory {
	if x != nil {
		return x.Category
	}
	return PackingCategory_PACKING_CATEGORY_UNSPECIFIED
}

func (x *PackingSuggestion) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *PackingSuggestion) GetEssential() bool {
	if x != nil {
		return x.Essential
	}
	return false
...
type SuggestPackingRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SuggestPackingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type SuggestPackingResponse struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	Suggestions []*PackingSuggestion   `protobuf:"bytes,1,rep,name=suggestions,proto3" json:"suggestions,omitempty"`
	...
	WeatherIsEstimated bool `protobuf:"varint,2,opt,name=weather_is_estimated,json=weatherIsEstimated,proto3" json:"weather_is_estimated,omitempty"`
	// False when no forecast was available at all; weather-driven suggestions are
	// then absent rather than guessed.
	UsedForecast  bool `protobuf:"varint,3,opt,name=used_forecast,json=usedForecast,proto3" json:"used_forecast,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SuggestPackingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SuggestPackingResponse) GetWeatherIsEstimated() bool {
	if x != nil {
...
func (x *SuggestPackingResponse) GetUsedForecast() bool {
	if x != nil {
		return x.UsedForecast
	}
	return false
}
...
type ChecklistItem struct {
	...
	Id   string            `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Kind ChecklistItemKind `protobuf:"varint,2,opt,name=kind,proto3,enum=loci.trip.ChecklistItemKind" json:"kind,omitempty"`
...
func (x *ChecklistItem) GetKind() ChecklistItemKind {
	if x != nil {
		return x.Kind
	}
	return ChecklistItemKind_CHECKLIST_ITEM_KIND_UNSPECIFIED
}
...
func (x *ChecklistItem) GetAmountMinor() int64 {
	if x != nil {
...
func (x *ChecklistItem) GetCurrency() string {
	if x != nil {
		return x.Currency
	}
	return ""
...
type GetTripChecklistRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TripId        string                 `protobuf:"bytes,1,opt,name=trip_id,json=tripId,proto3" json:"trip_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetTripChecklistRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type GetTripChecklistResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	DismissedSuggestions []string `protobuf:"bytes,2,rep,name=dismissed_suggestions,json=dismissedSuggestions,proto3" json:"dismissed_suggestions,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *GetTripChecklistResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetTripChecklistResponse) GetDismissedSuggestions() []string {
	if x != nil {
		return x.DismissedSuggestions
	}
	return nil
}

type UpsertChecklistItemRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TripId        string                 `protobuf:"bytes,1,opt,name=trip_id,json=tripId,proto3" json:"trip_id,omitempty"`
	Item          *ChecklistItem         `protobuf:"bytes,2,opt,name=item,proto3" json:"item,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpsertChecklistItemRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *UpsertChecklistItemRequest) GetItem() *ChecklistItem {
	if x != nil {
		return x.Item
	}
	return nil
...
func (x *DismissPackingSuggestionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DismissPackingSuggestionRequest) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
type DismissPackingSuggestionResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DismissPackingSuggestionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_loci_trip_trip_proto_rawDesc = "" +
	...
	"\bmobility\x18\x03 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dH\x01R\bmobility\x88\x01\x01\x12.\n" +
	"\tinterests\x18\x04 \x03(\tB\x10\xbaH\r\x92\x01\n" +
	"\x102\"\x06r\x04\x10\x01\x18dR\tinterests\x129\n" +
	"\x10day_start_minute\x18\x05 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\xa0\v(\x00H\x02R\x0edayStartMinute\x88\x01\x01\x125\n" +
	"\x0eday_end_minute\x18\x06 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\xa0\v(\x00H\x03R\fdayEndMinute\x88\x01\x01B\x0f\n" +
	"\r_budget_levelB\v\n" +
	"\t_mobilityB\x13\n" +
	...
	"\xbaH\ar\x05\x10\x01\x18\xac\x02R\x04name\x122\n" +
	"\fstart_minute\x18\x05 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\xa0\v(\x00H\x00R\vstartMinute\x88\x01\x01\x127\n" +
	"\x10duration_minutes\x18\x06 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00H\x01R\x0fdurationMinutes\x88\x01\x01\x12\x1e\n" +
	"\x05notes\x18\a \x01(\tB\b\xbaH\x05r\x03\x18\xa0\x1fR\x05notes\x123\n" +
	"\vbooking_url\x18\b \x01(\tB\r\xbaH\n" +
	"r\b\x10\x01\x18\x80\x10\x88\x01\x01H\x02R\n" +
	...
	"\x05stops\x18\x04 \x03(\v2\x13.loci.trip.TripStopR\x05stops\x12%\n" +
	"\tcity_name\x18\x05 \x01(\tB\b\xbaH\x05r\x03\x18\xc8\x01R\bcityName\x12'\n" +
	"\acity_id\x18\x06 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dH\x01R\x06cityId\x88\x01\x01\x127\n" +
	...
	"\aTripLeg\x12\x17\n" +
	"\x02id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x18dR\x02id\x12'\n" +
	"\tfrom_name\x18\x02 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xc8\x01R\bfromName\x12#\n" +
	"\ato_name\x18\x03 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xc8\x01R\x06toName\x122\n" +
	"\bfrom_lat\x18\x04 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x80V@)\x00\x00\x00\x00\x00\x80V\xc0R\afromLat\x122\n" +
	"\bfrom_lon\x18\x05 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x80f@)\x00\x00\x00\x00\x00\x80f\xc0R\afromLon\x12.\n" +
	"\x06to_lat\x18\x06 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x80V@)\x00\x00\x00\x00\x00\x80V\xc0R\x05toLat\x12.\n" +
	"\x06to_lon\x18\a \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x80f@)\x00\x00\x00\x00\x00\x80f\xc0R\x05toLon\x12/\n" +
	"\vdistance_km\x18\b \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\n" +
	"distanceKm\x12,\n" +
	"\rduration_mins\x18\t \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\fdurationMins\x12$\n" +
	"\tafter_day\x18\n" +
	" \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\bafterDay\x12\x1b\n" +
	"\x04mode\x18\v \x01(\tB\a\xbaH\x04r\x02\x18(R\x04mode\x123\n" +
	...
	"\n" +
	"created_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tcreatedAt\"\xb5\x01\n" +
	"\x11PackingSuggestion\x12\x1e\n" +
	"\x04text\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xac\x02R\x04text\x12@\n" +
	"\bcategory\x18\x02 \x01(\x0e2\x1a.loci.trip.PackingCategoryB\b\xbaH\x05\x82\x01\x02\x10\x01R\bcategory\x12 \n" +
	"\x06reason\x18\x03 \x01(\tB\b\xbaH\x05r\x03\x18\xf4\x03R\x06reason\x12\x1c\n" +
	"\tessential\x18\x04 \x01(\bR\tessential\";\n" +
	"\x15SuggestPackingRequest\x12\"\n" +
	"\atrip_id\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x06tripId\"\xaf\x01\n" +
	"\x16SuggestPackingResponse\x12>\n" +
	"\vsuggestions\x18\x01 \x03(\v2\x1c.loci.trip.PackingSuggestionR\vsuggestions\x120\n" +
	"\x14weather_is_estimated\x18\x02 \x01(\bR\x12weatherIsEstimated\x12#\n" +
	"\rused_forecast\x18\x03 \x01(\bR\fusedForecast\"\xd9\x02\n" +
	"\rChecklistItem\x12\x18\n" +
	"\x02id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x02id\x12<\n" +
	"\x04kind\x18\x02 \x01(\x0e2\x1c.loci.trip.ChecklistItemKindB\n" +
	"\xbaH\a\x82\x01\x04\x10\x01 \x00R\x04kind\x12\x1e\n" +
	"\x04text\x18\x03 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xac\x02R\x04text\x12\x12\n" +
	"\x04done\x18\x04 \x01(\bR\x04done\x12*\n" +
	"\famount_minor\x18\x05 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\vamountMinor\x120\n" +
	"\bcurrency\x18\x06 \x01(\tB\x14\xbaH\x11r\x0f2\r^([A-Z]{3})?$R\bcurrency\x12#\n" +
	"\bposition\x18\a \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\bposition\x129\n" +
	"\n" +
	"updated_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"=\n" +
	"\x17GetTripChecklistRequest\x12\"\n" +
	"\atrip_id\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x06tripId\"\x7f\n" +
	"\x18GetTripChecklistResponse\x12.\n" +
	"\x05items\x18\x01 \x03(\v2\x18.loci.trip.ChecklistItemR\x05items\x123\n" +
	"\x15dismissed_suggestions\x18\x02 \x03(\tR\x14dismissedSuggestions\"v\n" +
	"\x1aUpsertChecklistItemRequest\x12\"\n" +
	"\atrip_id\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x06tripId\x124\n" +
	"\x04item\x18\x02 \x01(\v2\x18.loci.trip.ChecklistItemB\x06\xbaH\x03\xc8\x01\x01R\x04item\"c\n" +
	"\x1aDeleteChecklistItemRequest\x12\"\n" +
	"\atrip_id\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x06tripId\x12!\n" +
	"\aitem_id\x18\x02 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x06itemId\"\x1d\n" +
	"\x1bDeleteChecklistItemResponse\"e\n" +
	"\x1fDismissPackingSuggestionRequest\x12\"\n" +
	"\atrip_id\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x06tripId\x12\x1e\n" +
	"\x04text\x18\x02 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xac\x02R\x04text\"\"\n" +
	" DismissPackingSuggestionResponse\"o\n" +
	...
	"\fbase_version\x18\x04 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\vbaseVersion\"\x86\x02\n" +
	"\x17EditStopDurationRequest\x12\"\n" +
	"\atrip_id\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x06tripId\x12\"\n" +
	"\astop_id\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x06stopId\x122\n" +
	"\fstart_minute\x18\x03 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\xa0\v(\x00H\x00R\vstartMinute\x88\x01\x01\x122\n" +
	...
	"\x19PACKING_CATEGORY_CLOTHING\x10\x02\x12\x1c\n" +
	"\x18PACKING_CATEGORY_WEATHER\x10\x03\x12\x19\n" +
	"\x15PACKING_CATEGORY_TECH\x10\x04\x12\x1b\n" +
	"\x17PACKING_CATEGORY_HEALTH\x10\x05\x12\x1b\n" +
	"\x17PACKING_CATEGORY_TRAVEL\x10\x06\x12\x1d\n" +
	"\x19PACKING_CATEGORY_ACTIVITY\x10\a*z\n" +
	"\x11ChecklistItemKind\x12#\n" +
	"\x1fCHECKLIST_ITEM_KIND_UNSPECIFIED\x10\x00\x12\x1f\n" +
	"\x1bCHECKLIST_ITEM_KIND_PACKING\x10\x01\x12\x1f\n" +
	"\x1bCHECKLIST_ITEM_KIND_EXPENSE\x10\x02*w\n" +
	...
	"\x10GetTripChecklist\x12\".loci.trip.GetTripChecklistRequest\x1a#.loci.trip.GetTripChecklistResponse\x12V\n" +
	"\x13UpsertChecklistItem\x12%.loci.trip.UpsertChecklistItemRequest\x1a\x18.loci.trip.ChecklistItem\x12d\n" +
	"\x13DeleteChecklistItem\x12%.loci.trip.DeleteChecklistItemRequest\x1a&.loci.trip.DeleteChecklistItemResponse\x12s\n" +
	"\x18DismissPackingSuggestion\x12*.loci.trip.DismissPackingSuggestionRequest\x1a+.loci.trip.DismissPackingSuggestionResponseBCZAgithub.com/FACorreiaa/loci-connect-proto/v5/gen/go/loci/trip;tripb\x06proto3"
