...
const file_loci_compare_v1_compare_proto_rawDesc = "" +
	...
	"eatSnippet\x125\n" +
	"\bgo_score\x18\x11 \x01(\v2\x1a.loci.localcontext.GoScoreR\agoScore\"\xab\x02\n" +
	"\vPlannedCity\x12'\n" +
	"\tcity_name\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xc8\x01R\bcityName\x12'\n" +
	"\acity_id\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dH\x00R\x06cityId\x88\x01\x01\x12)\n" +
