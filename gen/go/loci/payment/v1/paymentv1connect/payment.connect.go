...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/FACorreiaa/loci-connect-proto/v5/gen/go/loci/payment/v1"
	http "net/http"
	strings "strings"
)
...
var (
	paymentServiceServiceDescriptor                           = v1.File_loci_payment_v1_payment_proto.Services().ByName("PaymentService")
