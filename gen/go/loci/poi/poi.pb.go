...
const file_loci_poi_poi_proto_rawDesc = "" +
	...
	"\x06source\x18\x1b \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dH\x06R\x06source\x88\x01\x01\x12I\n" +
	"\x11uncertainty_score\x18\x1c \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\xf0?)\x00\x00\x00\x00\x00\x00\x00\x00H\aR\x10uncertaintyScore\x88\x01\x01\x123\n" +
	"\fmissing_data\x18\x1d \x03(\tB\x10\xbaH\r\x92\x01\n" +
	"\x10\x14\"\x06r\x04\x10\x01\x182R\vmissingData\x12J\n" +
	"\x18recommendation_rationale\x18\x1e \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xe8\aH\bR\x17recommendationRationale\x88\x01\x01\x12`\n" +
	...
	"\xbaH\ar\x05\x10\x01\x18\xf4\x03R\aaddress\x12E\n" +
	"\fphone_number\x18\t \x01(\tB\x1d\xbaH\x1ar\x18\x10\x01\x1822\x12^\\+?[1-9]\\d{1,14}$H\x00R\vphoneNumber\x88\x01\x01\x12,\n" +
	"\awebsite\x18\n" +
	" \x01(\tB\r\xbaH\n" +
	"r\b\x10\x01\x18\x80\x10\x88\x01\x01H\x01R\awebsite\x88\x01\x01\x124\n" +
	...
	"\awebsite\x18\t \x01(\tB\r\xbaH\n" +
	"r\b\x10\x01\x18\x80\x10\x88\x01\x01H\x01R\awebsite\x88\x01\x01\x12E\n" +
	"\fphone_number\x18\n" +
	" \x01(\tB\x1d\xbaH\x1ar\x18\x10\x01\x1822\x12^\\+?[1-9]\\d{1,14}$H\x02R\vphoneNumber\x88\x01\x01\x124\n" +
	"\ropening_hours\x18\v \x01(\tB\n" +
