...
func (x *POIDetailedInfo) Reset() {
	*x = POIDetailedInfo{}
	mi := &file_loci_poi_poi_proto_msgTypes[0]
...
func (*POIDetailedInfo) Descriptor() ([]byte, []int) {
	return file_loci_poi_poi_proto_rawDescGZIP(), []int{0}
}
...
var File_loci_poi_poi_proto protoreflect.FileDescriptor
...
const file_loci_poi_poi_proto_rawDesc = "" +
	...
	"\x0fdescription_poi\x18\x05 \x01(\tB\r\xbaH\n" +
	"\xd8\x01\x01r\x05\x10\x01\x18\xa0\x1fH\x00R\x0edescriptionPoi\x88\x01\x01\x12*\n" +
	"\bdistance\x18\x06 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\bdistance\x12;\n" +
	"\blatitude\x18\a \x01(\x01B\x1a\xbaH\x17\xd8\x01\x01\x12\x12\x19\x00\x00\x00\x00\x00\x80V@)\x00\x00\x00\x00\x00\x80V\xc0H\x01R\blatitude\x88\x01\x01\x12=\n" +
	"\tlongitude\x18\b \x01(\x01B\x1a\xbaH\x17\xd8\x01\x01\x12\x12\x19\x00\x00\x00\x00\x00\x80f@)\x00\x00\x00\x00\x00\x80f\xc0H\x02R\tlongitude\x88\x01\x01\x12&\n" +
	"\bcategory\x18\t \x01(\tB\n" +
	...
	"\fphone_number\x18\r \x01(\tB\x1d\xbaH\x1ar\x18\x10\x01\x1822\x12^\\+?[1-9]\\d{1,14}$R\vphoneNumber\x12'\n" +
	"\awebsite\x18\x0e \x01(\tB\r\xbaH\n" +
	"r\b\x10\x01\x18\x80\x10\x88\x01\x01R\awebsite\x12d\n" +
	...
	"\x06images\x18\x10 \x03(\tB\x14\xbaH\x11\x92\x01\x0e\x10\x14\"\n" +
	...
	"priceLevel\x12+\n" +
	"\areviews\x18\x13 \x03(\tB\x11\xbaH\x0e\x92\x01\v\x10d\"\ar\x05\x10\x01\x18\xd0\x0fR\areviews\x127\n" +
	"\x12llm_interaction_id\x18\x14 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x10llmInteractionId\x12$\n" +
	"\x04tags\x18\x15 \x03(\tB\x10\xbaH\r\x92\x01\n" +
	"\x10\x1e\"\x06r\x04\x10\x01\x18dR\x04tags\x12+\n" +
	"\bpriority\x18\x16 \x01(\x05B\n" +
	"\xbaH\a\xd8\x01\x01\x1a\x02(\x00H\x03R\bpriority\x88\x01\x01\x12A\n" +
	"\n" +
	"created_at\x18\x17 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tcreatedAt\x124\n" +
	"\fcuisine_type\x18\x18 \x01(\tB\f\xbaH\t\xd8\x01\x01r\x04\x10\x01\x18dH\x04R\vcuisineType\x88\x01\x01\x122\n" +
	"\vstar_rating\x18\x19 \x01(\tB\f\xbaH\t\xd8\x01\x01r\x04\x10\x01\x18\x14H\x05R\n" +
	...
	"\xbaH\ar\x05\x10\x01\x18\xf4\x03R\aaddress\x12H\n" +
	"\fphone_number\x18\t \x01(\tB \xbaH\x1d\xd8\x01\x01r\x18\x10\x01\x1822\x12^\\+?[1-9]\\d{1,14}$H\x00R\vphoneNumber\x88\x01\x01\x12/\n" +
	"\awebsite\x18\n" +
	" \x01(\tB\x10\xbaH\r\xd8\x01\x01r\b\x10\x01\x18\x80\x10\x88\x01\x01H\x01R\awebsite\x88\x01\x01\x127\n" +
	"\ropening_hours\x18\v \x01(\tB\r\xbaH\n" +
	"\xd8\x01\x01r\x05\x10\x01\x18\xf4\x03H\x02R\fopeningHours\x88\x01\x01\x122\n" +
	"\vprice_range\x18\f \x01(\tB\f\xbaH\t\xd8\x01\x01r\x04\x10\x01\x182H\x03R\n" +
	...
	"\x04tags\x18\x0e \x03(\tB\x10\xbaH\r\x92\x01\n" +
	"\x10\x1e\"\x06r\x04\x10\x01\x18dR\x04tags\x12,\n" +
	...
	"\vdescription\x18\a \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xa0\x1fR\vdescription\x12,\n" +
	"\aaddress\x18\b \x01(\tB\r\xbaH\n" +
	"\xd8\x01\x01r\x05\x10\x01\x18\xf4\x03H\x00R\aaddress\x88\x01\x01\x12/\n" +
	"\awebsite\x18\t \x01(\tB\x10\xbaH\r\xd8\x01\x01r\b\x10\x01\x18\x80\x10\x88\x01\x01H\x01R\awebsite\x88\x01\x01\x12H\n" +
	"\fphone_number\x18\n" +
	" \x01(\tB \xbaH\x1d\xd8\x01\x01r\x18\x10\x01\x1822\x12^\\+?[1-9]\\d{1,14}$H\x02R\vphoneNumber\x88\x01\x01\x127\n" +
	"\ropening_hours\x18\v \x01(\tB\r\xbaH\n" +
	"\xd8\x01\x01r\x05\x10\x01\x18\xf4\x03H\x03R\fopeningHours\x88\x01\x01\x122\n" +
	"\vprice_level\x18\f \x01(\tB\f\xbaH\t\xd8\x01\x01r\x04\x10\x01\x182H\x04R\n" +
	"priceLevel\x88\x01\x01\x124\n" +
	"\fcuisine_type\x18\r \x01(\tB\f\xbaH\t\xd8\x01\x01r\x04\x10\x01\x18dH\x05R\vcuisineType\x88\x01\x01\x12$\n" +
	"\x04tags\x18\x0e \x03(\tB\x10\xbaH\r\x92\x01\n" +
	"\x10\x1e\"\x06r\x04\x10\x01\x18dR\x04tags\x12,\n" +
	"\x06images\x18\x0f \x03(\tB\x14\xbaH\x11\x92\x01\x0e\x10\x14\"\n" +
	"r\b\x10\x01\x18\x80\x10\x88\x01\x01R\x06images\x12/\n" +
	...
	"\xd8\x01\x01r\x05\x10\x01\x18\xc8\x01H\x00R\x04city\x88\x01\x01\x12.\n" +
	"\bcategory\x18\x02 \x01(\tB\r\xbaH\n" +
	"\xd8\x01\x01r\x05\x10\x01\x18\xc8\x01H\x01R\bcategory\x88\x01\x01\x122\n" +
	"\vprice_range\x18\x03 \x01(\tB\f\xbaH\t\xd8\x01\x01r\x04\x10\x01\x182H\x02R\n" +
	"priceRange\x88\x01\x01B\a\n" +
	"\x05_cityB\v\n" +
	"\t_categoryB\x0e\n" +
	"\f_price_range\"\x94\x06\n" +
	...
	"\tlongitude\x18\x04 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x80f@)\x00\x00\x00\x00\x00\x80f\xc0R\tlongitude\x123\n" +
	"\tradius_km\x18\x05 \x01(\x01B\x11\xbaH\x0e\xd8\x01\x01\x12\t!\x00\x00\x00\x00\x00\x00\x00\x00H\x00R\bradiusKm\x88\x01\x01\x123\n" +
	"\vsearch_text\x18\x06 \x01(\tB\r\xbaH\n" +
	"\xd8\x01\x01r\x05\x10\x01\x18\xf4\x03H\x01R\n" +
	"searchText\x88\x01\x01\x121\n" +
	"\vsearch_tags\x18\a \x03(\tB\x10\xbaH\r\x92\x01\n" +
	"\x10\x14\"\x06r\x04\x10\x01\x18dR\n" +
	"searchTags\x122\n" +
	"\vsearch_type\x18\b \x01(\tB\f\xbaH\t\xd8\x01\x01r\x04\x10\x01\x18dH\x02R\n" +
	"searchType\x88\x01\x01\x12*\n" +
	"\asort_by\x18\t \x01(\tB\f\xbaH\t\xd8\x01\x01r\x04\x10\x01\x18dH\x03R\x06sortBy\x88\x01\x01\x127\n" +
	"\n" +
	"sort_order\x18\n" +
	" \x01(\tB\x13\xbaH\x10\xd8\x01\x01r\vR\x03ascR\x04descH\x04R\tsortOrder\x88\x01\x01\x12>\n" +
	"\n" +
	"min_rating\x18\v \x01(\x01B\x1a\xbaH\x17\xd8\x01\x01\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00H\x05R\tminRating\x88\x01\x01\x12.\n" +
	"\tmin_price\x18\f \x01(\tB\f\xbaH\t\xd8\x01\x01r\x04\x10\x01\x182H\x06R\bminPrice\x88\x01\x01\x12.\n" +
	"\n" +
	"min_guests\x18\r \x01(\x05B\n" +
	"\xbaH\a\xd8\x01\x01\x1a\x02(\x01H\aR\tminGuests\x88\x01\x01B\f\n" +
	"\n" +
	"_radius_kmB\x0e\n" +
	"\f_search_textB\x0e\n" +
	"\f_search_typeB\n" +
...
var (
	...
	file_loci_poi_poi_proto_rawDescData []byte
)

func file_loci_poi_poi_proto_rawDescGZIP() []byte {
	file_loci_poi_poi_proto_rawDescOnce.Do(func() {
		file_loci_poi_poi_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_loci_poi_poi_proto_rawDesc), len(file_loci_poi_poi_proto_rawDesc)))
	})
...
func file_loci_poi_poi_proto_init() {
	if File_loci_poi_poi_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_loci_poi_poi_proto_goTypes,
		DependencyIndexes: file_loci_poi_poi_proto_depIdxs,
		MessageInfos:      file_loci_poi_poi_proto_msgTypes,
	}.Build()
	File_loci_poi_poi_proto = out.File
	file_loci_poi_poi_proto_goTypes = nil
	file_loci_poi_poi_proto_depIdxs = nil
}
