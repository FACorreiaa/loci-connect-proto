...
const file_proto_review_proto_rawDesc = "" +
	"\n" +
	"\x12proto/review.proto\x12\x10ai_poi.review.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x12proto/common.proto\"\xf8\x06\n" +
	"\x06Review\x12\x19\n" +
	...
	"\x06photos\x18\a \x03(\tB\x0f\xbaH\f\x92\x01\t\"\ar\x05\x10\x01\x18\x80\x10R\x06photos\x12@\n" +
	...
	"isVerified\x12%\n" +
	"\blanguage\x18\x0f \x01(\tB\t\xbaH\x06r\x04\x10\x02\x18\n" +
	"R\blanguage\x129\n" +
	...
	"\rReviewAspects\x12>\n" +
	"\x0eservice_rating\x18\x01 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\rserviceRating\x12>\n" +
	"\x0equality_rating\x18\x02 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\rqualityRating\x12:\n" +
	"\fvalue_rating\x18\x03 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\vvalueRating\x12D\n" +
	"\x11atmosphere_rating\x18\x04 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\x10atmosphereRating\x12F\n" +
	"\x12cleanliness_rating\x18\x05 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\x11cleanlinessRating\x12@\n" +
	"\x0flocation_rating\x18\x06 \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\x0elocationRating\x128\n" +
	"\vfood_rating\x18\a \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\n" +
	"foodRating\x128\n" +
	"\vroom_rating\x18\b \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\n" +
	"roomRating\x12B\n" +
	"\x10amenities_rating\x18\t \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\x0famenitiesRating\x12:\n" +
	"\fstaff_rating\x18\n" +
	" \x01(\x01B\x17\xbaH\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\x00\x00R\vstaffRating\"\xbf\x02\n" +
	"\fReviewerInfo\x12\"\n" +
	...
	"\n" +
	"avatar_url\x18\x03 \x01(\tB\b\xbaH\x05r\x03\x18\x80\x10R\tavatarUrl\x12*\n" +
	...
	"percentage\"\xef\x03\n" +
	"\fReviewFilter\x12C\n" +
	"\x0erating_filters\x18\x01 \x03(\x01B\x1c\xbaH\x19\x92\x01\x16\"\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\x14@)\x00\x00\x00\x00\x00\x00\xf0?R\rratingFilters\x129\n" +
	"\n" +
	...
	"\tlanguages\x18\x04 \x03(\tB\x0e\xbaH\v\x92\x01\b\"\x06r\x04\x10\x02\x18\n" +
	"R\tlanguages\x12#\n" +
	"\rverified_only\x18\x05 \x01(\bR\fverifiedOnly\x12(\n" +
	"\x10with_photos_only\x18\x06 \x01(\bR\x0ewithPhotosOnly\x12*\n" +
	"\bkeywords\x18\a \x03(\tB\x0e\xbaH\v\x92\x01\b\"\x06r\x04\x10\x01\x18dR\bkeywords\x127\n" +
	"\asort_by\x18\b \x01(\x0e2\x1e.ai_poi.review.v1.ReviewSortByR\x06sortBy\x12F\n" +
	"\x0esort_direction\x18\t \x01(\x0e2\x1f.ai_poi.review.v1.SortDirectionR\rsortDirection\"\xa1\x03\n" +
	...
	"\xbaH\ar\x05\x10\x01\x18\xa0\x1fR\acontent\x12.\n" +
	"\n" +
	"photo_urls\x18\x06 \x03(\tB\x0f\xbaH\f\x92\x01\t\"\ar\x05\x10\x01\x18\x80\x10R\tphotoUrls\x129\n" +
	"\n" +
	...
	"\blanguage\x18\t \x01(\tB\t\xbaH\x06r\x04\x10\x02\x18\n" +
	"R\blanguage\"{\n" +
