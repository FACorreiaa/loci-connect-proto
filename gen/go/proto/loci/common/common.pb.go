...
const file_proto_loci_common_common_proto_rawDesc = "" +
	"\n" +
	"\x1eproto/loci/common/common.proto\x12\vloci.common\x1a\x1bbuf/validate/validate.proto\"\x88\x01\n" +
	"\bResponse\x12\x18\n" +
	...
	"\asort_by\x18\x03 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dH\x00R\x06sortBy\x88\x01\x01\x124\n" +
	"\n" +
	"sort_order\x18\x04 \x01(\tB\x10\xbaH\rr\vR\x03ascR\x04descH\x01R\tsortOrder\x88\x01\x01B\n" +
	"\n" +
	"\b_sort_byB\r\n" +
