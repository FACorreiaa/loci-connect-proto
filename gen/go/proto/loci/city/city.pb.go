...
const file_proto_loci_city_city_proto_rawDesc = "" +
	...
	"\acountry\x18\x03 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\acountry\x128\n" +
	"\x0estate_province\x18\x04 \x01(\tB\f\xbaH\t\xd8\x01\x01r\x04\x10\x01\x18dH\x00R\rstateProvince\x88\x01\x01\x12)\n" +
	"\n" +
	"ai_summary\x18\x05 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xa0\x1fR\taiSummary\x12H\n" +
	"\x0fcenter_latitude\x18\x06 \x01(\x01B\x1a\xbaH\x17\xd8\x01\x01\x12\x12\x19\x00\x00\x00\x00\x00\x80V@)\x00\x00\x00\x00\x00\x80V\xc0H\x01R\x0ecenterLatitude\x88\x01\x01\x12J\n" +
	"\x10center_longitude\x18\a \x01(\x01B\x1a\xbaH\x17\xd8\x01\x01\x12\x12\x19\x00\x00\x00\x00\x00\x80f@)\x00\x00\x00\x00\x00\x80f\xc0H\x02R\x0fcenterLongitude\x88\x01\x01B\x11\n" +
	"\x0f_state_provinceB\x12\n" +
	"\x10_center_latitudeB\x13\n" +
	"\x11_center_longitude\"\xa2\x05\n" +
	"\x0fGeneralCityData\x12\x1e\n" +
	"\x04city\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xc8\x01R\x04city\x12#\n" +
	"\acountry\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\acountry\x128\n" +
	"\x0estate_province\x18\x03 \x01(\tB\f\xbaH\t\xd8\x01\x01r\x04\x10\x01\x18dH\x00R\rstateProvince\x88\x01\x01\x12,\n" +
	"\vdescription\x18\x04 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xa0\x1fR\vdescription\x12H\n" +
	"\x0fcenter_latitude\x18\x05 \x01(\x01B\x1a\xbaH\x17\xd8\x01\x01\x12\x12\x19\x00\x00\x00\x00\x00\x80V@)\x00\x00\x00\x00\x00\x80V\xc0H\x01R\x0ecenterLatitude\x88\x01\x01\x12J\n" +
	"\x10center_longitude\x18\x06 \x01(\x01B\x1a\xbaH\x17\xd8\x01\x01\x12\x12\x19\x00\x00\x00\x00\x00\x80f@)\x00\x00\x00\x00\x00\x80f\xc0H\x02R\x0fcenterLongitude\x88\x01\x01\x12)\n" +
	"\n" +
