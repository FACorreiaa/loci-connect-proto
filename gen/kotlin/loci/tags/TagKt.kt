...
public inline fun tag(block: loci.tags.TagKt.Dsl.() -> kotlin.Unit): loci.tags.Tags.Tag =
  loci.tags.TagKt.Dsl._create(loci.tags.Tags.Tag.newBuilder()).apply { block() }._build()
/**
 * ```
 * Matches locitypes.Tags
 * ```
 *
 * Protobuf type `loci.tags.Tag`
 */
public object TagKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: loci.tags.Tags.Tag.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: loci.tags.Tags.Tag.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): loci.tags.Tags.Tag = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun loci.tags.Tags.Tag.copy(block: `loci.tags`.TagKt.Dsl.() -> kotlin.Unit): loci.tags.Tags.Tag =
  `loci.tags`.TagKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val loci.tags.Tags.TagOrBuilder.createdAtOrNull: com.google.protobuf.Timestamp?
  get() = if (hasCreatedAt()) getCreatedAt() else null

public val loci.tags.Tags.TagOrBuilder.updatedAtOrNull: com.google.protobuf.Timestamp?
