...
public inline fun personalTag(block: loci.tags.PersonalTagKt.Dsl.() -> kotlin.Unit): loci.tags.Tags.PersonalTag =
  loci.tags.PersonalTagKt.Dsl._create(loci.tags.Tags.PersonalTag.newBuilder()).apply { block() }._build()
/**
 * ```
 * Matches locitypes.PersonalTag
 * ```
 *
 * Protobuf type `loci.tags.PersonalTag`
 */
public object PersonalTagKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: loci.tags.Tags.PersonalTag.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: loci.tags.Tags.PersonalTag.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): loci.tags.Tags.PersonalTag = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun loci.tags.Tags.PersonalTag.copy(block: `loci.tags`.PersonalTagKt.Dsl.() -> kotlin.Unit): loci.tags.Tags.PersonalTag =
  `loci.tags`.PersonalTagKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val loci.tags.Tags.PersonalTagOrBuilder.createdAtOrNull: com.google.protobuf.Timestamp?
  get() = if (hasCreatedAt()) getCreatedAt() else null

public val loci.tags.Tags.PersonalTagOrBuilder.updatedAtOrNull: com.google.protobuf.Timestamp?
