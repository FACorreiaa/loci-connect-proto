...
public inline fun tag(block: ai_poi.tags.v1.TagKt.Dsl.() -> kotlin.Unit): ai_poi.tags.v1.Tags.Tag =
  ai_poi.tags.v1.TagKt.Dsl._create(ai_poi.tags.v1.Tags.Tag.newBuilder()).apply { block() }._build()
/**
 * ```
 * Matches locitypes.Tags
 * ```
 *
 * Protobuf type `ai_poi.tags.v1.Tag`
 */
public object TagKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: ai_poi.tags.v1.Tags.Tag.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: ai_poi.tags.v1.Tags.Tag.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): ai_poi.tags.v1.Tags.Tag = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun ai_poi.tags.v1.Tags.Tag.copy(block: `ai_poi.tags.v1`.TagKt.Dsl.() -> kotlin.Unit): ai_poi.tags.v1.Tags.Tag =
  `ai_poi.tags.v1`.TagKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val ai_poi.tags.v1.Tags.TagOrBuilder.createdAtOrNull: com.google.protobuf.Timestamp?
  get() = if (hasCreatedAt()) getCreatedAt() else null

public val ai_poi.tags.v1.Tags.TagOrBuilder.updatedAtOrNull: com.google.protobuf.Timestamp?
